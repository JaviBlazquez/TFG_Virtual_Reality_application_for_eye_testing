...
public class EyeFollowsBallRight : MonoBehaviour
{
    public GameObject ball;
    public float gazeThreshold = 1f;
    private float gazeTimeRight = 0f;
    ...
    void Update()
    {
        ...
        Debug.Log($"Tiempo siguiendo la pelota ojo der: {gazeTimeRight:F2} segundos");
        PlayerPrefs.SetFloat("GazeTimeder", gazeTimeRight);
        PlayerPrefs.Save();
    }
}
