...
public class EyeFollowsBallLeft : MonoBehaviour
{
    public GameObject ball;
    public float gazeThreshold = 1f;
    private float gazeTimeLeft = 0f;
    ...
    void Update()
    {
        ...
        Debug.Log($"Tiempo siguiendo la pelota ojo izq: {gazeTimeLeft:F2} segundos");
        PlayerPrefs.SetFloat("GazeTimeLeft", gazeTimeLeft);
        PlayerPrefs.Save();
    }
}
